...
export const increaseVesting = async (cmd: Command) => {
    ...
    while (i < numOfLoop) {
        ...
        const encoded = claimsContract.methods.increaseVesting(vestingArg, amtArg).encodeABI();
