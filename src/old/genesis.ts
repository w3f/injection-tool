...
export const getClaimsContract = (w3: any, claimsAbi: any = ClaimsAbi, address: string = ClaimsAddress): any => new w3.eth.Contract(claimsAbi, address);

export const getFrozenTokenContract = (w3: any, frozenTokenAbi: any = FrozenTokenAbi, address: string = FrozenTokenAddress): any => new w3.eth.Contract(frozenTokenAbi, address);
