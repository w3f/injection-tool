...
program
  ...
  .option(
    ...
    "One or more CSV files formatted <dest>,<amount> on each line."
  )
  .option(
    "--source <source>",
    "The address from which funds will be force transferred from."
  )
  .option("--cryptoType <type>", "One of ed25519 or sr25519.", "sr25519")
  .option(
    "--wsEndpoint <url>",
    "The endpoint of the WebSockets to connect with.",
    "wss://rpc.polkadot.io"
  )
  .option("--mnemonic <string>", "Pass in the mnemonic for the Sudo key.")
  .option("--suri <suri>", "Pass in the suri for the Sudo key.")
  .option(
    "--jsonPath <pathToKeystore>",
    "Pass in the path to the JSON keystore for the Sudo key."
  )
...
program
  ...
  .option(
    "--startingBlock <num>",
    "The block to start the linear vesting.",
    "0"
  )
  .option(
    "--perBlock <[all,auto]>",
    "How to calculate perBlock. auto: standard 2 year schedule, all: single block unlock",
    "auto"
  )
...
program
  ...
  .option(
    "--csv <filepath[,filepath,...]>",
    "One or more CSV files formatted <destination>,<amount> on each line."
  )
  .option(
    "--cryptoType <type>",
    "One of ed25519 or sr25519, depending on the crypto used to derive your keys.",
    "sr25519"
  )
  .option("--dry", "Runs in dry run mode.")
  .option(
    "--wsEndpoint <url>",
    "The endpoint of the WebSockets to connect.",
    "wss://rpc.polkadot.io"
  )
...
program
  ...
  .option(
    "--prevHashes <filepath>",
    "A file of previous hashes of the extrinsics."
  )
  .option("--cryptoType <type>", "One of ed25519 or sr25519.", "sr25519")
  .option(
    "--wsEndpoint <url>",
...
program
  ...
  .option(
    ...
    "The starting nonce for transactions.",
    "0"
  )
  .option(
    "--output <filepath>",
    "The file to write the raw transactions.",
    "raw_tx.csv"
  )
  .option(
    "--csv <filepath[,filepath,...]>",
    "One or more CSV files formatted <original>,<amended> on each line."
  )
  .option(
    "--claims <address>",
    "The address of DOT Claims.",
    "0xa2CBa0190290aF37b7e154AEdB06d16100Ff5907"
  )
  .option(
    "--providerUrl <url>",
    "A WebSockets provider for an Ethereum node.",
    "ws://localhost:8546"
  )
  .option("--from <address>", "Sender of the transactions.")
  .option("--gas <amount>", "Amount of gas to send.", "2000000")
  .option(
    "--gasPrice <price_in_wei>",
    "Amount to pay in wei per each unit of gas",
    "8500000000"
  )
  .option(
    "--password <string>",
    "The password to unlock personal_* RPC methods on the node."
  )
...
program
  ...
  .option(
    "--csv <filepath[,filepath,...]>",
    "One or more CSV files formatted <address> on each line."
  )
  .option(
    "--claims <address>",
    "The address of DOT Claims.",
...
program
  ...
  .option(
    "--csv <filepath[,filepath,...]>",
    "One or more CSV files formatted with a single raw and signed transaction in hex on each line.",
    ""
  )
  .option(
    "--providerUrl <url>",
...
program
  ...
  .option(
    "--dotIndicator <address>",
    "Address of the DOT indicator contract.",
  ...
  .option(
    "--gasPrice <price_in_wei>",
    "Amount to pay in wei per unit of gas.",
    "8500000000"
  )
  .option(
    "--password <string>",
...
program
  ...
  .description(
    "Make claims from the sending address. Useful mostly in combination with eth:amend."
  )
  .option(
    "--nonce <starting_nonce>",
    "The starting nonce for transactions.",
  ...
  .option(
    "--csv <filepath[,filepath,...]>",
    "One or more CSV files formatted <dotHolder>,<pubKey> on each line."
  )
  .option(
    "--claims <address>",
    "The address of DOT Claims.",
...
program
  ...
  .description(
    "Make transfers of Frozen Token (must send from a liquid account)."
  )
  .option(
    "--nonce <starting_nonce>",
    "The starting nonce for transactions.",
  ...
  .option(
    "--csv <filepath[,filepath,...]>",
    "One or more CSV files formatted <address>,<amount> on each line."
  )
  .option(
    "--frozenToken <address>",
    "The address of the Frozen Token",
    "0xb59f67A8BfF5d8Cd03f6AC17265c550Ed8F33907"
  )
  .option(
    "--providerUrl <url>",
...
program
  ...
  .description(
    "Increase the vested amount of token holders on the Claims contract."
  )
  .option(
    "--nonce <starting_nonce>",
    "The starting nonce for transactions.",
...
program
  ...
  .option(
    "--csv <filepath[,filepath,...]>",
    "One or more CSV file formatted <address>,<amount> on each line."
  )
  .option(
    "--claims <address>",
    "The address of the Claims contract.",
...
program
  ...
  .description(
    "Set the vested amount of token holders on the Claims contract (can only be called once on an address, otherwise use eth:increase-vesting)."
  )
  .option(
    "--nonce <starting_nonce>",
    "The starting nonce for transactions.",
...
program
  ...
  .option(
    "--csv <filepath[,filepath,...]>",
    "One or more CSV files formatted <dotHolder> on each line."
  )
  .option(
    "--claims <address>",
    "The address of DOT Claims.",
...
program
  ...
  .option(
    ...
    "The start of the block number you would like to scan.",
    "9430800"
  )
  .option(
    "--endBlock <endBlock>",
    "The end of the block number you would like to scan.",
    "9431000"
  )
  .option("-y --noConfirm", "Skips the confirmation prompt.")
...
program
  ...
  .option(
    "--claimAddress <addr>",
    "The address of DOT Claims contract.",
    "0xa2CBa0190290aF37b7e154AEdB06d16100Ff5907"
  )
  .option(
    "--frozenTokenAddress <addr>",
    "The address of Frozen Token.",
    "0xb59f67A8BfF5d8Cd03f6AC17265c550Ed8F33907"
  )
  ...
  .option(
    "--providerUrl <url>",
    "A WebSockets provider for an Ethereum node.",
    "wss://mainnet.infura.io/ws/v3/7121204aac9a45dcb9c2cc825fb85159"
  )
  .option("-y --noConfirm", "Skips the confirmation prompt.")
