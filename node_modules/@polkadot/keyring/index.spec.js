...
describe('keypair', () => {
  ...
  describe('ed25519', () => {
    ...
    it('creates a ed25519 pair via mnemonicToSeed', () => {
      expect(keypair.addFromUri('seed sock milk update focus rotate barely fade car face mechanic mercy').address).toEqual('5DkQP32jP4DVJLWWBRBoZF2tpWjqFrcrTBo6H5NcSk7MxKCC');
    });
    it('adds from a mnemonic', () => {
      (0, _utilCrypto.setAddressPrefix)(68);
      expect(keypair.addFromMnemonic('moral movie very draw assault whisper awful rebuild speed purity repeat card', {}).address).toEqual('7sPsxWPE5DzAyPT3VuoJYw5NTGscx9QYN9oddQx4kALKC3hH');
    });
  ...
  describe('sr25519', () => {
    ...
    it('adds from a mnemonic', () => {
      (0, _utilCrypto.setAddressPrefix)(68);
      expect(keypair.addFromMnemonic('moral movie very draw assault whisper awful rebuild speed purity repeat card', {}).address).toEqual('7qQGarA4PWjPPVHG4USn1yuuVZvEHN7XZz8o7EbAp48jayZQ');
    });
    it('allows publicKeys retrieval', () => {
      keypair.addFromSeed(seedTwo, {});
      expect(keypair.getPublicKeys()).toEqual([publicKeyOne, publicKeyTwo]);
